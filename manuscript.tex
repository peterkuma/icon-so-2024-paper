...
We partitioned our data into subsets by cyclonic activity. For this purpose,
...
We used the open source cylone tracking package CyTRACK
...
cyclones in the observations, ERA5 pressure and wind fields were used as the
input to CyTRACK. This is justified by the fact that large-scale pressure and
wind fields are likely sufficiently close to the reality in ERA5. For
identifying cyclones in ICON, ERA5, MERRA-2, their own pressure and wind fields
were used as the input to CyTRACK.
