...
Institute and Pangaea, AA15-16 dataset provided by the
...
Atmospheric Research and UC, RV \emph{Nathaniel B. Palmer} dataset provided
by the National Science Foundation, Cooperative Institute for Research in
Environmental Sciences, University of Colorado and UC, HMNZS \emph{Wellington}
dataset provided by the Royal New Zealand Navy and UC, the MARCUS dataset was
provided by the Atmospheric Radiation Measurement (ARM). The MICRE dataset was
provided by ARM, the Australian Bureau of Meteorology, AAD and UC.  We thank
the scientific staff, the crew, and everyone involved in collecting data on the
...
model output provided by the nextGEMS project and the Deutsches
Klimarechenzentrum (DKRZ), reanalysis dataset ERA5 provided by the Copernicus
Climate Change Service and MERRA-2 provided by the Global Modeling and
Assimilation Office. We dedicate this study to the memory of Mike J. Harvey,
who very substantially contributed to obtaining atmospheric measurments on the
...
The RV \emph{Polarstern} datasets are openly available from Pangaea
...
Science Data Centre (\url{https://asdc.larc.nasa.gov/project/CERES}).
The TAN1802 data ara available on Zenodo
