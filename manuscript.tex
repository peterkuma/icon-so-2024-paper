...
\begin{center} \Large \sffamily\textbf{Using ship observations to assess Southern Ocean clouds in the storm-resolving general circulation model ICON}\\[0.4cm]
...
MCQ16-18 (9 days): 7--8, 29 June, 5, 16 July, 15 August, 17 October 2016, 11
...
CL51 and CL31 operating at 910 nm and the Lufft CHM-15k operating at 1064 nm. A
...
horizontal resolution is 0.25$^\circ$ in latitude and longitude, which is about
28 km in the North--South direction and 14 km in the East--West direction at
60$^\circ$S. The model uses 137 vertical levels. In our analysis we use output
...
Vertically-resolved quantities are specified on pressure levels. We interpolate
these quantities to height levels as needed.
...
and station histograms. The models and subsets are as in Fig.
