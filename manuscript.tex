...
\ref{fig:cloud-occurrence}b, c), we can see that the low-latitude SO zone shows
...
\ref{fig:cloud-occurrence}d, e), we can see that the cyclonic situations have a
...
\ref{sec:cyclone-stability}, we can see that in the relatively stable
...
and spread across 0--1 km.  In the relatively stable situations, the models are
doing a fairly good job, but overestimate cloud occurrence at the peak below 1
km; above 1 km, they show similar biases as in the general case.  In the
relatively unstable situations the bias in ICON is very pronounced, with a much
stronger peak at about 500 m, ERA5 is underestimating cloud occurrence below 1
km (especially near the surface), and MERRA-2 even more strongly.
...
present in ERA5 in the relatively unstable subset, where it peaks at 3 oktas, whereas the
