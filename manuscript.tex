...
alternative to using a computationally costly GSRM is to train an artificial
...
The data sources contained ceilometer observations captured by the Vaisala CL51
 perating at a wavelenght of 910 nm, the Vaisala CT25K operating at 905 nm, and
...
evaluation perspective different from satellite observations, one that is more
...
relate to the biases. Our main finding corroborates previous findings of large
...
other hand, the advantage of a much higher spatial resolution and, to a limited
...
storm-resolving models might not solve these biases without additional
...
large-eddy simulations are two potential avenues for future research that
...
innovation program under a grant agreement no. 101003470, and supercomputing
