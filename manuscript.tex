...
Institute and Pangaea, RSV \emph{Aurora Australis} datasets provided by the
Australian Antarctic Program and the University of Canterbury (UC), RV
\emph{Tangaroa} datasets provided by the National Institute of Water and
Atmospheric Research and the UC, RV \emph{Nathaniel B. Palmer} dataset provided
by the National Science Foundation, Cooperative Institute for Research in
Environmental Sciences, University of Colorado and the UC, HMNZS
\emph{Wellington} dataset provided by the Royal New Zealand Navy and the UC and
the Macquarie Island station dataset provided by the Atmospheric Radiation
Measurement and the UC.  We thank the scientific staff, the crew, and everyone
...
Garrett, Jamie Halla, Sean Hartery, Mike J.  Harvey (†), Simon P.  Alexander and
Alex Schuddeboom. We acknowledge the ICON model output provided by the nextGEMS
project and the Deutsches Klimarechenzentrum (DKRZ), reanalysis dataset ERA5
provided by the Copernicus Climate Change Service and MERRA-2 provided by the
Global Modeling and Assimilation Office. We would like to dedicate this study
...
openly available from the Copernicus Climate Data Store (CDS)
