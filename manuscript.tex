...
models analysed by \cite{schuddeboom2021} over high-latitude SO, whereas over
low-latitude SO it tends to be more neutral or negative in some models. Too
...
analysed 48 hours of km-scale ICON limited area model NWP simulation over a SO
region adjacent to Tasmania agaist the Clouds, Aerosols, Precipitation,
...
thickness underestimated relative to Himawari‐8 satellite observations, but
also large differences in cloud top phase.
