...
Among them is a 5-km version of the Icosahedral Nonhydrostatic Weather and Climate Model
...
reflecting too much SW radiation from clouds, but has too little cloudarea
...
the data sources and longitudes. We conclude that the ICON results ch the observations better than the reanalyses in this metric.
...
model cloud simulations in this fast-changing and understudied region. However, this analysis suggests that the
