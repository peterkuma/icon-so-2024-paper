...
\hypersetup{
	...
	pdfauthor={Peter Kuma, Frida A.-M. Bender, Adrian J. McDonald, …}
}
...
\large Peter Kuma$^\mathsf{1,}$*, Frida A.-M. Bender$^\mathsf{1}$, Adrian J. McDonald$^\mathsf{2}$, \ldots\\[0.4cm]
\small
$^\mathsf{1}$Department of Meteorology (MISU) and the Bolin Centre for Climate Research, Stockholm University, Stockholm SE-106 91, Sweden\\
$^\mathsf{2}$School of Physical and Chemical Sciences, University of Canterbury, Christchurch, Aotearoa/New Zealand\\[0.2cm]
...
on two 40-day time periods in summer (1 August -- 10 September 2016) and winter
